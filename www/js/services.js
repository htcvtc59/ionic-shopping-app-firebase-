...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://ionicshoppingcart-11261.firebaseio.com/"),
    refCart = new Firebase("https://ionicshoppingcart-11261.firebaseio.com/cart"),
    refUser = new Firebase("https://ionicshoppingcart-11261.firebaseio.com/users"),
    refCategory = new Firebase("https://ionicshoppingcart-11261.firebaseio.com/category"),
    refOrder = new Firebase("https://ionicshoppingcart-11261.firebaseio.com/orders"),
    refFeatured = new Firebase("https://ionicshoppingcart-11261.firebaseio.com/featured"),
    refMenu = new Firebase("https://ionicshoppingcart-11261.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
